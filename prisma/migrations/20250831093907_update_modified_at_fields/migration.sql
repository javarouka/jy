...
INSERT INTO "new_AcademicActivityLog" ("act", "activityDate", "activityName", "activityType", "createdAt", "creditTime", "id", "modifiedAt", "organization", "sessionName", "usable") SELECT "act", "activityDate", "activityName", "activityType", "createdAt", "creditTime", "id", "modifiedAt", "organization", "sessionName", "usable" FROM "AcademicActivityLog";
...
INSERT INTO "new_OtherActivityLog" ("activitySummary", "activityType", "createdAt", "creditTime", "endDate", "id", "modifiedAt", "startDate", "usable") SELECT "activitySummary", "activityType", "createdAt", "creditTime", "endDate", "id", "modifiedAt", "startDate", "usable" FROM "OtherActivityLog";
...
INSERT INTO "new_ResearchLog" ("createdAt", "id", "journalName", "modifiedAt", "pagerName", "participateType", "publishDate", "usable") SELECT "createdAt", "id", "journalName", "modifiedAt", "pagerName", "participateType", "publishDate", "usable" FROM "ResearchLog";
