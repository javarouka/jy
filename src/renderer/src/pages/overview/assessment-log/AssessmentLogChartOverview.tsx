          ...
          <div className="space-y-8">
            {chartData.map((yearData) => (
              <div key={yearData.name} className="border rounded-lg p-4 border-gray-200 dark:border-gray-700">
                ...
                <div className="mb-6">
                  <h5 className="text-md font-medium mb-2">월별 인정시간</h5>
                  {yearData.monthlyData.length === 0 ? (
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      ...
                      >
                        ...
                        <XAxis dataKey="month" />
                        <YAxis label={{ value: '인정시간 (분)', angle: -90, position: 'insideLeft' }} />
                        <Tooltip formatter={(value) => [`${value} 분`, '인정시간']} />
                        <Legend />
                ...
                <div className="flex flex-row space-x-4">
                  ...
                  <div className="w-1/2">
                    <h5 className="text-md font-medium mb-2">성별 분포</h5>
                  ...
                  <div className="w-1/2">
                    <h5 className="text-md font-medium mb-2">검사 유형 분포</h5>
