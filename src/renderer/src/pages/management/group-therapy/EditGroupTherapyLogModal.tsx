...
type Props = {
  isOpen: boolean
  onClose: () => void
  log: GroupTherapyLog | null
  onSave: (id: number, data: TypeGroupTherapyFormData) => void
}

const EditGroupTherapyLogModal = ({ isOpen, onClose, log, onSave }: Props) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-2xl max-h-[90vh] overflow-y-auto p-6">
        <div className="flex justify-between items-center mb-4 pb-2 border-b border-gray-200">
          <h3 className="text-lg font-medium">집단심리치료 기록 수정</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="my-2 space-y-4">
          <div className="text-sm">
            <label htmlFor="edit-groupName" className="font-bold">그룹명</label>
            <input
              type="text"
              id="edit-groupName"
              name="groupName"
...
export default EditGroupTherapyLogModal
