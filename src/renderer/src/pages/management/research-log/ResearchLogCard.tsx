...
const ResearchLogCard = ({ log, onDelete, onEdit }: ResearchLogCardProps) => {
  const handleDelete = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-4 border border-gray-200 hover:shadow-lg transition-shadow">
      <div className="flex justify-between items-start mb-2">
        <h3 className="text-lg font-semibold text-gray-800">{log.pagerName}</h3>
...
export default ResearchLogCard
